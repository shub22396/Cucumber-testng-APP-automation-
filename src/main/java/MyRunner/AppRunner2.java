...
@CucumberOptions(
        features = "src/main/java/Features/App2.feature",
...
public class AppRunner2 {
    ...
    public static AppiumDriver connection;
    ...
    public void setUpClass(String platformName, String platformVersion, String deviceName) throws Exception {
        ...
        capability.setCapability("app", "lt://APP10020521645630018779928");
        ...
        connection = new AppiumDriver(new URL(gridURL), capability);
